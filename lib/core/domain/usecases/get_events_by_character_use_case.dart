...
/// This use case allows us to obtain events by character
class GetEventsByCharacterUseCase extends UseCaseParams<CommonFailure,
  ...
  Future<Either<CommonFailure, DataCharacterDetailEntity>> execute(
    ...
    return _charactersRepository.getEventsByCharacter(params);
  }
}
