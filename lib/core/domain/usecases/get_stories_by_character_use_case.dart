...
/// This use case allows us to obtain stories by character
class GetStoriesByCharacterUseCase extends UseCaseParams<CommonFailure,
  ...
  Future<Either<CommonFailure, DataCharacterDetailEntity>> execute(
    ...
    return _charactersRepository.getStoriesByCharacter(params);
  }
}
